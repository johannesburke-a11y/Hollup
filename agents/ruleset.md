...
| **Instructional Designer subagent** | Specialised subagent — eLearning design, storyboarding, build handoff | Writes to `projects/<slug>/storyboard.md` only — see `agents/instructional-designer.md` |
